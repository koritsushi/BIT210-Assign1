...
registrationRouter.get("/:id", async(req, res) => {
    try {
        ...
        const registration = await collections?.activites?.findOne(querry);
...
registrationRouter.post("/", async (req, res) => {
    try {
        ...
        const result = await collections?.activites?.insertOne(registration);
...
registrationRouter.put("/:id", async (req, res) => {
    try {
        ...
        const result = await collections?.activites?.updateOne(query, { $set: registration });
